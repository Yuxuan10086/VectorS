// PD42 步进闭环驱动器应用层 SDK（帧格式见手册 4.1 / 《控制协议 V1.2》xlsx）
#ifndef ROBOT_DRIVER__PD42_MOTOR_SDK_HPP_
#define ROBOT_DRIVER__PD42_MOTOR_SDK_HPP_
...
/** 工作模式：仅列出 SDK 使用的通信位置 / 通信速度（0x62） */
namespace work_mode
{
...
{
  return 0x1000U | (static_cast<uint32_t>(slave_addr) & 0x0FU);
}

}  // namespace robot_driver

#endif  // ROBOT_DRIVER__PD42_MOTOR_SDK_HPP_
